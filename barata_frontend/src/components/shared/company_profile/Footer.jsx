...
export default function Footer(){
  return (
    <section className={`${styles.flexCenter} ${styles.paddingY} flex-col bg-blue-950`}>
            ...
            <div key={footerlink.title} className={`flex flex-col ss:my-0 my-4 min-w-[150px]`}>
              ...
              <ul className="list-none mt-4">
                {footerlink.links.map((link, index) => (
                  <li
                    key={link.name}
                    className={`font-poppins font-normal text-[14px] leading-[24px] text-gray-50 hover:text-yellow-500 cursor-pointer ${
      ...
      <div className="w-full flex justify-between items-center md:flex-row flex-col pt-6 border-t-[1px] border-t-[#3F3E45] mx-20 ">
