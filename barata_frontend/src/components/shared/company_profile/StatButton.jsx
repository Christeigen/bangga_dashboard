...
//           onClick={() => handleButtonClick(customer_id, withdraw_id, 100)} // Change the status accordingly
//         >
//           Accept
//         </button>
//         <button
//           className="px-2 py-2 text-red-900 text-sm bg-red-200 rounded-lg flex flex-row"
//           onClick={() => handleButtonClick(customer_id, withdraw_id, 200)} // Change the status accordingly
//         >
//           Reject
//         </button>
//       </div>
