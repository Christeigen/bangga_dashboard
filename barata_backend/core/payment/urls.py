...
from .views import PaymentCreateView, PaymentMethodCreateView, PaymentActiveView, PaymentRequestCreateView, PaymentPaidView, PaymentMethodGet, NotificationSend, PaymentRequestCallbackView, PaymentRequestCreateEMoneyView
from . import views
...
urlpatterns = [
    ...
    path('payment/create-payment-request/', PaymentRequestCreateEMoneyView.as_view(), name = "payment-request"),
